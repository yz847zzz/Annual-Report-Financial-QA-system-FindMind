...
def get_field_number(sql):
    ...
    for word in sql_words:
        ...
        if word.startswith('('):
            word = word[1:]
        # Only validate fields used in SQL conditions.
