...
def report_score(score, scorejson, out_p):
    ...
    # Keep the `score` field in {}, but you can add other keys if needed, e.g.:
...
class countScore():
    def __init__(self):
        self.sys_path = standard_path  # Reference answer file path
        self.simModel_path = './data/pretrained_models/text2vec-base-chinese'  # Similarity model path
