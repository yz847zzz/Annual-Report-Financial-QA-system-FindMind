...
# Monetary unit: CNY. No space between numbers and the unit.
# Ratio questions should not include a percent sign; quick ratio and current ratio should also stay non-percentage; other rate-like outputs may require percentage formatting.
...
def is_type2_growth_rate(question):
    # The question does not include a year.
