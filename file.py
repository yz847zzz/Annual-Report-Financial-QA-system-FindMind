...
def download_data():
    with open(os.path.join(cfg.DATA_PATH, 'test', 'C-list-pdf-name.txt'), 'r', encoding='utf-8') as f:
...
if __name__ == '__main__':
    ...
    for key in pdf_info.keys():
        # key = '2021-03-23__Soochow Keda Technology...__603660__Soochow Keda__2020__AnnualReport.pdf'
        print(key)
